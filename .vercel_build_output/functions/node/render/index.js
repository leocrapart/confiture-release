...
var manifest = {
  ...
  routes: [
    ...
    },
    {
      ...
      pattern: /^\/confitures\/?$/,
      params: empty,
      a: ["src/routes/__layout.svelte", "src/routes/confitures.svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    },
    {
      type: "page",
...
var module_lookup = {
  ...
  "src/routes/confitures.svelte": () => Promise.resolve().then(function() {
    return confitures;
  }),
...
var Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div class="${"flex py-2 bg-gray-900 justify-center uppercase text-gray-100"}">Les confitures de valerie
</div>`;
});
...
<div><div class="${"pt-48 px-12"}"><div class="${"flex pl-3"}">a la une :</div>
		<div class="${"flex mt-4"}"><div class="${"flex flex-wrap max-w-md"}"><div class="${"w-48 h-48 m-4 border border-gray-500 rounded"}"></div>
				<div class="${"w-48 h-48 m-4 border border-gray-500 rounded"}"></div>
				<div class="${"w-48 h-48 m-4 border border-gray-500 rounded"}"></div>
				<div class="${"w-48 h-48 m-4 border border-gray-500 rounded"}"></div></div>
			<div class="${"pl-80 self-end italic text-sm"}"><div class="${"pr-28 pl-1 border border-gray-500 rounded"}"><div>contact</div>
					<div class="${"pt-3"}"><div>mail:</div>
						<div>instagram</div>
						<div>facebook...</div></div></div></div></div></div></div>`;
});
...
var Confitures = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div><div class="${"grid p-40"}"><div class="${"w-40 h-40 border"}"></div>
        <div class="${"w-40 h-40 border"}"></div>
        <div class="${"w-40 h-40 border"}"></div></div></div>`;
});
var confitures = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  [Symbol.toStringTag]: "Module",
  "default": Confitures
});
...
<div class="${"content"}"><h1>About this app</h1>
	...
	<p>This is a <a href="${"https://kit.svelte.dev"}">SvelteKit</a> app. You can make
	...
	<p>The <a href="${"/todos"}">TODOs</a> page illustrates SvelteKit&#39;s data loading
